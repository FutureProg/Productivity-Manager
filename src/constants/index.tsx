...
export const OPEN_TOPIC_DETAIL_MODAL = 'OPEN_TOPIC_DETAIL_MODAL';
export type OPEN_TOPIC_DETAIL_MODAL = typeof OPEN_TOPIC_DETAIL_MODAL;

export const CLOSE_TOPIC_DETAIL_MODAL = 'CLOSE_TOPIC_DETAIL_MODAL';
export type CLOSE_TOPIC_DETAIL_MODAL = typeof CLOSE_TOPIC_DETAIL_MODAL;
